...
for train_index, test_index in kf.split(X):
    ...
    valence_report_df.to_csv(
        f'/Users/sudaxin/Desktop/EmoEst CNN result/valence_classification_report_fold_{fold}.csv')
    ...
    arousal_report_df.to_csv(
        f'/Users/sudaxin/Desktop/EmoEst CNN result/arousal_classification_report_fold_{fold}.csv')
    ...
    plt.ylabel('Actual')
    plt.savefig(f'/Users/sudaxin/Desktop/EmoEst CNN result/valence_confusion_matrix_fold_{fold}.png')
    plt.close()
    ...
    plt.xlabel('Predicted')
    plt.ylabel('Actual')
    plt.savefig(f'/Users/sudaxin/Desktop/EmoEst CNN result/arousal_confusion_matrix_fold_{fold}.png')
    plt.close()
    ...
    plt.savefig(f'/Users/sudaxin/Desktop/EmoEst CNN result/valence_roc_curve_fold_{fold}.png')
    plt.close()
    ...
    plt.legend(loc="lower right")
    plt.savefig(f'/Users/sudaxin/Desktop/EmoEst CNN result/arousal_roc_curve_fold_{fold}.png')
    plt.close()
...
valence_report_avg_df.to_csv('/Users/sudaxin/Desktop/EmoEst CNN result/valence_classification_report_avg.csv')
arousal_report_avg_df.to_csv('/Users/sudaxin/Desktop/EmoEst CNN result/arousal_classification_report_avg.csv')

# Save the model
model.save('/Users/sudaxin/Desktop/EmoEst CNN result/model.keras')
...
metrics_df.to_csv('/Users/sudaxin/Desktop/EmoEst CNN result/metrics_summary.csv', index=False)