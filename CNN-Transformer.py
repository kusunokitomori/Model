...
def create_cnn_transformer_model(input_shape, num_heads=8, ff_dim=128):
...
plot_model(model, to_file='/Users/sudaxin/Desktop/EmoEst combined result/model_plot.png', show_shapes=True, show_layer_names=True)
...
for train_index, test_index in kf.split(X):
    ...
    model = create_cnn_transformer_model((X.shape[1], 1))
    ...
    valence_report_df.to_csv(
        f'/Users/sudaxin/Desktop/EmoEst combined result/valence_classification_report_fold_{fold}.csv')
    ...
    arousal_report_df.to_csv(
        f'/Users/sudaxin/Desktop/EmoEst combined result/arousal_classification_report_fold_{fold}.csv')
    ...
    plt.ylabel('Actual')
    plt.savefig(f'/Users/sudaxin/Desktop/EmoEst combined result/valence_confusion_matrix_fold_{fold}.png')
    plt.close()
    ...
    plt.xlabel('Predicted')
    plt.ylabel('Actual')
    plt.savefig(f'/Users/sudaxin/Desktop/EmoEst combined result/arousal_confusion_matrix_fold_{fold}.png')
    plt.close()
    ...
    plt.savefig(f'/Users/sudaxin/Desktop/EmoEst combined result/valence_roc_curve_fold_{fold}.png')
    plt.close()
    ...
    plt.legend(loc="lower right")
    plt.savefig(f'/Users/sudaxin/Desktop/EmoEst combined result/arousal_roc_curve_fold_{fold}.png')
    plt.close()
...
valence_report_avg_df.to_csv('/Users/sudaxin/Desktop/EmoEst combined result/valence_classification_report_avg.csv')
arousal_report_avg_df.to_csv('/Users/sudaxin/Desktop/EmoEst combined result/arousal_classification_report_avg.csv')
...
metrics_df.to_csv('/Users/sudaxin/Desktop/EmoEst combined result/metrics_summary.csv', index=False)
